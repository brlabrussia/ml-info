...
import scrapy
from banks.scraper.items import ConsumerCreditItem
...
class Loader(BaseLoader):
    default_item_class = ConsumerCreditItem
...
class Spider(scrapy.Spider):
    ...
    def parse_items(self, response):
        ...
        loader.add_css('banki_updated_at', '[data-test=read-more]', re=r'Дата актуализации: (.+)\. ')
