...
import scrapy
from banks.scraper.items import DepositItem
from common.scraper.items import BaseLoader
from common.scraper.utils import drop_falsy, format_date, format_url
from funcy import rcompose
from scrapy.loader.processors import Identity, Join, MapCompose


class Loader(BaseLoader):
    default_item_class = DepositItem

    url_bank_banki_in = MapCompose(format_url)
...
class Spider(scrapy.Spider):
    ...
    def parse_items(self, response):
        ...
        loader.add_xpath('url_bank_banki', '//h1/ancestor::header/following-sibling::div//a/@href')
        ...
        loader.add_css('banki_updated_at', '.expand-content span::text', re=r'Дата актуализации: (.+)\.\s')
