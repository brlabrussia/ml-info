...
from investments.scraper.items import MutualItem
from scrapy.loader.processors import Identity, MapCompose


class Loader(BaseLoader):
    default_item_class = MutualItem
...
class Spider(scrapy.Spider):
    ...
    def parse_items(self, response, filter_, logo):
        ...
        loader.add_xpath('investment_min', '//*[starts-with(normalize-space(text()), "Минимальная инвестиция")]/following-sibling::*[has-class("header-h2")]/text()', re=r'[\d\s]+')
